...
public class BigDecimalUtil {
    ...
    /**
     * 舍入规则 BigDecimal.ROUND_DOWN 直接删除多余小数; BigDecimal.ROUND_UP 直接进位处理(3.11110001 = 3.1112; 3.11119999 = 3.1112);
     * BigDecimal.ROUND_HALF_UP 四舍五入; BigDecimal.ROUND_HALF_DOWN 四舍五弃六入;
     */
     ...
     * @return
     */
    public static BigDecimal addForDecimal(double a, double b) {
     ...
     * @return
     */
    public static BigDecimal subtractForDecimal(double a, double b) {
     ...
     * @return
     */
    public static Double multiplyUp(double value1, double value2) {
        BigDecimal bd1 = new BigDecimal(Double.toString(value1));
        BigDecimal bd2 = new BigDecimal(Double.toString(value2));
     ...
     * @return
     */
    public static Double divideUp(double value1, double value2) {
        BigDecimal bd1 = new BigDecimal(Double.toString(value1));
        BigDecimal bd2 = new BigDecimal(Double.toString(value2));
     ...
     * @return
     */
    public static Double multiplyDown(double value1, double value2) {
        BigDecimal bd1 = new BigDecimal(Double.toString(value1));
        BigDecimal bd2 = new BigDecimal(Double.toString(value2));
